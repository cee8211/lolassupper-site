        ...
        items: [
          {
            ...
            recipe: {
              ...
              ingredients: [
                ...
                '2 oranges for 2 tbsp zest and ¼ cup orange juice',
                '1 cup extra-virgin olive oil',
                '1 cup sugar',
                '3 large eggs',
                '1 tsp vanilla extract',
                '¼ cup orange liqueur (Cointreau, Grand Marnier, or sweet orange wine) — or sub more OJ',
                '2 cups all-purpose flour',
                '1 tsp sea salt',
                '1 tsp baking powder',
                '¼ tsp baking soda',
                'Optional: icing sugar, fresh berries, orange zest to garnish',
              ],
              steps: [
                'Heat oven to 350°F / 175°C.',
                'Prep a 9-inch cake pan with baking spray or a little olive oil. Line the bottom with parchment paper.',
                'Slice 1 unpeeled orange into ⅛-inch thick slices. Arrange the largest centre slices on the parchment in concentric circles. Squeeze any remaining slices into a small bowl.',
                'Zest the remaining 2 oranges to get at least 2 tbsp. Squeeze for at least ¼ cup juice.',
                'In a large bowl, whisk together olive oil, sugar, eggs, vanilla, orange zest, orange juice, and orange liqueur.',
                'In a second bowl, whisk flour, salt, baking soda, and baking powder. Add to the liquid ingredients and stir until just combined. (Tip: skip the second bowl and sift the dry ingredients straight in!)',
                'Pour batter into the prepared pan. Bake for 50 min, checking at 45 min — done when the top is medium golden brown and a tester comes out clean.',
                'Cool in pan for 20 min, then remove and cool completely for another hour. Dust with icing sugar to serve.',
              ],
            },
          },
        ],
